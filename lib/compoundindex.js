...
module.exports = class CompoundIndex
{
    ...
    /**
     * @param {string} column
     * @param {module.Transformation} tf
     * @return {module.CompoundIndex}
     */
    ...
    /**
     * @param {module.RowTransformation} tf
     */
    addRowTransform(tf)
    {
    ...
    /**
     * @returns {module.RowTransformation[]}
     */
    getRowTransforms()
    {
    ...
    async getPacked(row)
    {
        ...
        return await (new Compound()).invoke(pieces);
    }
};
