...
module.exports = class ModernCrypto extends Backend
{
    ...
    async doStreamDecrypt(
        ...
        await poly.update(Buffer.alloc(3, 0)); // (0x10 - 45) & 0xf
        ...
        await poly.update(Util.store64_le(45));
    ...
    async doStreamEncrypt(
        ...
        await poly.update(salt);
        await poly.update(nonce);
        await poly.update(Buffer.alloc(3, 0)); // (0x10 - 45) &
        ...
        await poly.update(Buffer.alloc((0x10 - inputFileSize) & 0xf, 0));
        await poly.update(Util.store64_le(45));
        await poly.update(Util.store64_le(inputFileSize));
